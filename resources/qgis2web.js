...
map.getView().fit([-9992256.175479, 5177759.805113, -8815538.253861, 6083484.806358], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Club Locations</h2>';
        return titleElement;
    })(),
